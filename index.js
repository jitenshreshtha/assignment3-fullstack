...
const { gPost } = require('./controllers/gPost.js');
const { examiner, markDriver } = require('./controllers/examiner.js');
const { examinerComment } = require('./controllers/examinerComment.js');
const { candidateController } = require('./controllers/candidates.js');
const { result } = require('./controllers/result.js');
const { listCandidates } = require('./controllers/admin');
...
app.post("/gPost", authenticateDriver, gPost);
...
app.get('/candidates', candidateController);
app.get('/result', result);
app.post('/examiner/comment', examinerComment);
app.post('/markDriver', authenticateExaminer, markDriver);
app.get('/admin/candidates', listCandidates);
app.get("*", (req, res) => {
